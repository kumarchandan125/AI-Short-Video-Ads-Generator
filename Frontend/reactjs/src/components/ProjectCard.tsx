      ...
      <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
        ...
        >
          ...
          <div className="absolute left-3 top-3 flex gap-2 items-center">
            {gen.isGenerating && (
              <span className="px-2 py-1 bg-yellow-600/30 rounded-full">
                Generating
              </span>
            )}
            {gen.isPublished && (
          ...
          {/* action menu for my generation page only  */}
          {!forCommunity && (
            <div
              onMouseDownCapture={() => {
                setMenuOpen(true);
            ...
            >
              ...
              <div className="flex flex-col itme-end w-32 text-sm">
                <ul
                ...
                >
                  ...
                  {(gen.generatedVideo || gen.generatedImage) && (
                    <button
                      ...
                      className="w-full flex gap-2 item-center px-4 py-2 hover:bg-black/10 cursor-pointer"
                    >
                      <ShareIcon size={14} />
                      Share
                    </button>
                  ...
                  <button
                    ...
                    className="w-full flex gap-2 item-center px-4 py-2 hover:bg-red-950/10 
            ...
            <div className="flex-1">
              ...
              {gen.updatedAt && (
                <p className="text-xs text-gray-500 mt-1">
                  Updated: {new Date(gen.createdAt).toLocaleString()}
                </p>
              )}
            </div>
